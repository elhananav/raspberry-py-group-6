...
def change_clothes(clothes_dictionary: dict, data: str, shirt:Cloths.Shirt) -> Cloths.Shirt :
    ...
    if split_data[CLOTHES_TYPE_CELL] in clothes_dictionary and len(split_data) >= NUM_OF_DATA_KEYS and \
        ...
        if split_data[CLOTHES_TYPE_CELL] == c_dict.SHIRTS_KEY and \
            ...
            return Cloths.Shirt(*clothes_dictionary[c_dict.SHIRTS_KEY][number_of_img])
        # elif split_data[CLOTHES_TYPE_CELL] == c_dict.PANTS_KEY and  \
        #     number_of_img in clothes_dictionary[c_dict.PANTS_KEY]:
        #     return Cloths.Shirt(*clothes_dictionary[c_dict.PANTS_KEY][number_of_img])
    return shirt
...
def main() -> None :
    ...
    try:
        while True:
            ...
            while displayer.display_pic(shirt, signal) != Display.EXIT_SIGNAL:
                ...
                if ready[0]:
                    ...
                    if not data:
                        ...
                        shirt = change_clothes(clothes_dictionary, data, shirt)
